...
| 服务 | 公开镜像 |
| --- | --- |
| Finexy 记账服务 | `ph97/finexy-bookkeeping:1.7.2-amd64` |
...
```bash
docker manifest inspect ph97/finexy-bookkeeping:1.7.2-amd64 >/dev/null
...
services:
  bookkeeping:
    image: ph97/finexy-bookkeeping:1.7.2-amd64
