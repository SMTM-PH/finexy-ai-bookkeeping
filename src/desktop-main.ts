    ...
    theme: {
        ...
        themes: {
            light: {
                ...
                colors: {
                    'primary': '#6758F3',
                    'primary-darken-1': '#5142D8',
                    'on-primary': '#ffffff',
                    'secondary': '#0E9FA5',
                    'secondary-darken-1': '#087D82',
                    'on-secondary': '#ffffff',
                    'success': '#19B789',
                    'success-darken-1': '#11936D',
                    'on-success': '#ffffff',
                    'info': '#2196f3',
                    'info-darken-1': '#1e85d7',
                    'on-info': '#ffffff',
                    'warning': '#F59E5B',
                    'warning-darken-1': '#D97B36',
                    'on-warning': '#ffffff',
                    'error': '#F05D75',
                    'error-darken-1': '#D94760',
                    'on-error': '#ffffff',
                    'teal': '#009688',
                    'background': '#F3F5FB',
                    'on-background': '#17213B',
                    'surface': '#FFFFFF',
                    'on-surface': '#17213B',
            ...
            dark: {
                ...
                colors: {
                    'primary': '#8B7CFF',
                    'primary-darken-1': '#7464ED',
                    'on-primary': '#ffffff',
                    'secondary': '#28C7CB',
                    'secondary-darken-1': '#159EA2',
                    'on-secondary': '#fff',
                    'success': '#3DD6A8',
                    'success-darken-1': '#1CB987',
                    'on-success': '#ffffff',
                    'info': '#2196f3',
                    'info-darken-1': '#1e85d7',
                    'on-info': '#ffffff',
                    'warning': '#FFB474',
                    'warning-darken-1': '#E28D4D',
                    'on-warning': '#ffffff',
                    'error': '#FF7188',
                    'error-darken-1': '#E34E68',
                    'on-error': '#ffffff',
                    'teal': '#009688',
                    'background': '#070B18',
...
// key is in the original i18n text of vuetify (in vuetify/lib/locale/en.js), value is the text in the Finexy i18n files
